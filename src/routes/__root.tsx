...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Avika Nigam — AI Engineer in the Making" },
      {
        name: "description",
        content:
          "Interactive portfolio of Avika Nigam — BCA student and AI/ML learner building practical AI-powered products.",
      },
      { name: "author", content: "Avika Nigam" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=DM+Sans:opsz,wght@9..40,400;9..40,500&display=swap",
      },
    ],
  }),
